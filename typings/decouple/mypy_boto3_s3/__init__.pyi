...
if sys.version_info >= (3, 12):
    ...
    ...
__all__ = ("AnalyticsS3ExportFileFormatType", "ArchiveStatusType", "BucketAccelerateStatusType", "BucketCannedACLType", "BucketExistsWaiterName", "BucketLocationConstraintType", "BucketLogsPermissionType", "BucketNotExistsWaiterName", "BucketTypeType", "BucketVersioningStatusType", "ChecksumAlgorithmType", "ChecksumModeType", "ChecksumTypeType", "CompressionTypeType", "DataRedundancyType", "DeleteMarkerReplicationStatusType", "EncodingTypeType", "EventType", "ExistingObjectReplicationStatusType", "ExpirationStatusType", "ExpressionTypeType", "FileHeaderInfoType", "FilterRuleNameType", "IntelligentTieringAccessTierType", "IntelligentTieringStatusType", "InventoryFormatType", "InventoryFrequencyType", "InventoryIncludedObjectVersionsType", "InventoryOptionalFieldType", "JSONTypeType", "ListBucketsPaginatorName", "ListDirectoryBucketsPaginatorName", "ListMultipartUploadsPaginatorName", "ListObjectVersionsPaginatorName", "ListObjectsPaginatorName", "ListObjectsV2PaginatorName", "ListPartsPaginatorName", "LocationTypeType", "MFADeleteStatusType", "MFADeleteType", "MetadataDirectiveType", "MetricsStatusType", "ObjectAttributesType", "ObjectCannedACLType", "ObjectExistsWaiterName", "ObjectLockEnabledType", "ObjectLockLegalHoldStatusType", "ObjectLockModeType", "ObjectLockRetentionModeType", "ObjectNotExistsWaiterName", "ObjectOwnershipType", "ObjectStorageClassType", "ObjectVersionStorageClassType", "OptionalObjectAttributesType", "OwnerOverrideType", "PaginatorName", "PartitionDateSourceType", "PayerType", "PermissionType", "ProtocolType", "QuoteFieldsType", "RegionName", "ReplicaModificationsStatusType", "ReplicationRuleStatusType", "ReplicationStatusType", "ReplicationTimeStatusType", "RequestChargedType", "RequestPayerType", "ResourceServiceName", "RestoreRequestTypeType", "S3ServiceName", "ServerSideEncryptionType", "ServiceName", "SessionModeType", "SseKmsEncryptedObjectsStatusType", "StorageClassAnalysisSchemaVersionType", "StorageClassType", "TaggingDirectiveType", "TierType", "TransitionDefaultMinimumObjectSizeType", "TransitionStorageClassType", "TypeType", "WaiterName")
